...
# register(
#     id='VecContinuousActions_ContinuousStates-v0',
#     entry_point='gym_roblox.envs:VecContinuousActions_ContinuousStates') # NAme of the CLASS after the colon

register(
    id='MultiAgent-v0',
    entry_point='gym_roblox.envs:MultiAgent') # NAme of the CLASS after the colon
